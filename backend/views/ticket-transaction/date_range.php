...
<div class="received-cash-index" style="padding-top: 10px">
    <?php echo $this->render('_search_date_range', ['model' => $searchModel]); ?>
        ...
        'gridOptions' => [
          ...
          //  'filterModel'=>$searchModel,
            ...
            'panel' => [
                ...
                'heading' => '<strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> CUSTOM REPORT </strong>',
