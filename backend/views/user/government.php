    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <?php if (Yii::$app->user->can('admin') || Yii::$app->user->can('super_admin')) { ?>
                <?= Html::a(Yii::t('app', '<i class="fa fa-user"></i> New Gvt Agent'), ['gvt-create'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
                <?= Html::a(Yii::t('app', '<i class="fa fa-th-list"></i> Gvt Agent List'), ['gvt'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
            <?php } ?>
        </div>
    </div>
    <hr/>
