            ...
            <div class="box-body">
                ...
                <div class="col-xs-12 col-lg-12 col-sm-12">
                    ...
                    <div class="col-sm-12 no-padding">
                        ...
                        <div class="col-sm-3">
                            <?= $form->field($model, 'role')->dropDownList(\backend\models\User::getRulesAccountant(), ['prompt' => '-- select Role name --']) ?>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-lg-4">
                        ...
                        <div class="col-xs-6 col-xs-12">
                            <?= Html::a(Yii::t('app', 'Cancel'), ['managers-list'], ['class' => 'btn btn-warning btn-block']) ?>
                        </div>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
