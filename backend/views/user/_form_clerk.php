                    ...
                    <div class="col-sm-12 no-padding">
                        ...
                        <div class="col-sm-4">
                            <?= $form->field($model, 'municipal')->widget(Select2::classname(), [
                                'data' => \backend\models\Region::getRegion(),
                                'options' => ['placeholder' => 'Choose Shehia'],
                                'pluginOptions' => [
                                    'allowClear' => true,
        ...
        <div class="user-index" style="padding-top: 40px;padding-left: 10px">
            ...
            <div class="box-body">
                ...
                <div class="col-sm-12 no-padding">
                    ...
                    <div class="col-sm-3">
                        <?= $form->field($model, 'role')->dropDownList(\backend\models\User::getRulesClerk(), ['prompt' => '-- select Role name --']) ?>
                    </div>
                    <div class="col-sm-3">
                        <?= $form->field($model, 'status')->dropDownList(\backend\models\User::getArrayStatus()) ?>
                    </div>
...
>>>>>>> bd573e7596ed001d891d392f65c10b36d6a5ebae
