        ...
        if (!Yii::$app->user->isGuest) {
            ...
            if ($model->load(Yii::$app->request->post()) && $model->login()) {
                ...
                if (Yii::$app->user->identity->role != ''){
                    if (\Yii::$app->user->identity->role == 'super_admin' || \Yii::$app->user->identity->role == 'admin' || \Yii::$app->user->identity->role == 'manager' || \Yii::$app->user->identity->role == 'government_official') {
