                    ...
                    [
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'icon' => 'navicon text-green',
                            ],           [
                                //  'visible' =>  yii::$app->user->can('auditSystem'),
                                'label' => Yii::t('app', 'Graph Report'),
                                'url' => ['/ticket-transaction/graph'],
                                'icon' => 'bar-chart text-green',
                            ],

                            [
                                //  'visible' =>  yii::$app->user->can('auditSystem'),
                                'label' => Yii::t('app', 'Custom Reports'),
                                'url' => ['/ticket-transaction/custom'],
                                'icon' => 'line-chart text-green',
                            ],
